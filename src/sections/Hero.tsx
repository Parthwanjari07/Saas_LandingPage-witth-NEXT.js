...
export default function Hero() {
    return <section className="py-24 overflow-cliped">
        <div className="container relative">
            ...
            <p className="text-center text-white/50 text-xl mt-8 mx-auto max-w-xl">
                ...
                Layers combined with the latest technology to create a seamless user experience.
            </p>
            <form className="grid grid-cols-2 border border-white/15 rounded-full p-2 mt-8 max-w-lg mx-auto">
                <input type="email" placeholder="Enter your email" className="bg-transparent text-white/50 placeholder:text-white/50 pl-6  w-full" />
