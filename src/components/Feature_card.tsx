...
export default function FeatureCard({ image, title, description }: FeatureProps) {
    return (
        <div className="bg-white/5  border border-white/15 rounded-3xl p-6 aspect-square flex flex-col">
